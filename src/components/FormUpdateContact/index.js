...
import { updateContact } from "./../../utils/persistData";

export default function FormUpdateContact({ contact }) {

  const { enqueueSnackbar } = useSnackbar();
  const {setRefresh, refresh, setShowUpdateContact } = useGlobal();
