...
import FormNewContact from "../../FormNewContact/index";
import CardBase from "../CardBase";
import { Container } from "./styles";

export default function NewContact() {
  const { showNewContact, setShowNewContact } = useGlobal();

  return (
    <CardBase isShown={showNewContact} setIsShown={() => setShowNewContact(false)} >
      <Container>
        <div className="new-contact-top">
          <span>Adicionar novo contacto</span>
          <svg
            width="15"
            height="15"
            viewBox="0 0 18 17"
